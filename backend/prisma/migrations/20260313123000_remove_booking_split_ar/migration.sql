...
INSERT INTO "new_Booking" ("artistId", "createdAt", "customerId", "date", "endTime", "id", "notes", "placement", "preference", "pricingType", "projectName", "shortCode", "startTime", "status", "studioId", "totalAmount", "updatedAt")
SELECT "artistId", "createdAt", "customerId", "date", "endTime", "id", "notes", "placement", "preference", "pricingType", "projectName", "shortCode", "startTime", "status", "studioId", "totalAmount", "updatedAt" FROM "Booking";
DROP TABLE "Booking";
